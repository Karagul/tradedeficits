shinyUI(fluidPage(
  sidebarPanel(
    ...
    checkboxGroupInput("sitc.codes", "Products (SITC Code):",
                       c("Food and Live Animals (0)" = 0,
                         "Beverages and Tobacco (1)" = 1,
                         "Crude Materials, except Fuels (2)" = 2,
                         "Fuels, Lubricants, Related (3)" = 3,
                         "Animal/Veg Oils, Fats, Waxes (4)" = 4,
                         "Chemicals and Related (5)" = 5,
                         "Manufactured Materials (6)" = 6,
                         "Machinery and Transport (7)" = 7,
                         "Misc. Manufactured Articles (8)" = 8,
                         "Commodities and Other (9)" = 9),
              selected = c(0:9)),
    plotOutput("deficit")
  ),
  mainPanel(
